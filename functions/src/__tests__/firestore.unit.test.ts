...
describe('Firestore Service (Unit Tests)', () => {
  ...
  describe('createGroup', () => {
    ...
    it('should create groups with different names', async () => {
  ...
  describe('addUserToGroup', () => {
    it('should add user to group with default admin status', async () => {
      ...
      expect(userGroupDoc.data()?.isAdmin).toBe(true); // First user becomes admin automatically
      ...
      expect(groupMemberDoc.data()?.isAdmin).toBe(true); // First user becomes admin automatically
  ...
  describe('getGroupDetails', () => {
    ...
    it('should return empty members array for group with no members', async () => {
  ...
  describe('createKittyTransaction', () => {
    ...
    it('should create transaction without comment', async () => {
      ...
      expect(transactionDoc.data()?.comment).toBe(''); // Empty string when no comment provided
    });
  });
